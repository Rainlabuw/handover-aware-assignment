...
"""
Implementation of CBBA for solving the minimum handover assignment problem.
Would not recommend using this for anything other than testing, as it is
unoptimized and quite slow.

See original implementation here: https://acl.mit.edu/projects/consensus-based-bundle-algorithm
"""
